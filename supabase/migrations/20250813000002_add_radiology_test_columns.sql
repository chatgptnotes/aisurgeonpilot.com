-- ========================================
-- MIGRATION: ADD RADIOLOGY TEST COLUMNS
-- ========================================
...
COMMENT ON COLUMN public.requisitions.radiology_test_names IS 'Array of radiology test names for radiology requisitions';
COMMENT ON COLUMN public.requisitions.radiology_test_costs IS 'Array of radiology test costs corresponding to test names';
