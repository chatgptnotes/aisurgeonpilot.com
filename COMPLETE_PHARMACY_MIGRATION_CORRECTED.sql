-- =====================================================
-- COMPLETE PHARMACY MIGRATION (CORRECTED VERSION)
-- Use this instead of the original migration
-- patient_id and visit_id are VARCHAR(255) from the start
-- =====================================================
...
CREATE TABLE public.pharmacy_sales (
    ...
    -- ✅ CORRECTED: VARCHAR instead of BIGINT
...
SELECT
    ps.sale_id,
    ps.sale_type,
    ps.patient_id,          -- Now VARCHAR
    ps.patient_name,
    ps.visit_id,            -- Now VARCHAR
    ps.sale_date,
...
CREATE OR REPLACE FUNCTION public.create_pharmacy_sale(
    p_sale_type TEXT,
    p_patient_id TEXT,              -- ✅ Changed to TEXT
    p_patient_name TEXT,
    p_visit_id TEXT,                -- ✅ Changed to TEXT
...
-- ✅ Done! Tables created with correct VARCHAR types from the start
