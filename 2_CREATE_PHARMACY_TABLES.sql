-- =====================================================
-- STEP 2: Create pharmacy tables and objects
-- Run this AFTER running 1_DROP_ALL_PHARMACY_OBJECTS.sql
-- =====================================================
...
-- =====================================================
-- STEP 2: Create pharmacy_sales table
-- =====================================================
...
CREATE TABLE public.pharmacy_sales (
    ...
    -- ✅ VARCHAR for string IDs like "UHAY25F27002"
...
CREATE FUNCTION public.create_pharmacy_sale(
    p_sale_type TEXT,
    p_patient_id TEXT,
    p_patient_name TEXT,
    p_visit_id TEXT,
...
-- ✅ Done! Now test your pharmacy billing form
